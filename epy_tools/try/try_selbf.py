def compute_accumulated_number(profit_rate, n_years, base_number):
    return sum([base_number * profit_rate ** i for i in range(n_years)])

compute_accumulated_number(1.05, 40, 3000)
...
env = gym.make('lbforaging:SEForaging-15s-1_2_3_4_5_6_15-15x15-4p-5f-v1')
env.seed(SEED)
