...
`vdn/lbforaging-Foraging-2s-15x15-3p-5f-v1` => `vdn_2s/lbforaging-Foraging-15s-15x15-3p-5f-v1`
...
PARSER.add_argument('--new-sight', type=str, help='新的視野範圍', default='15s')
...
for subdir in subdirs:
    ...
    if 's-' in subdir:
        ...
        new_dir = subdir.replace(sight_str, ARGS.new_sight)
