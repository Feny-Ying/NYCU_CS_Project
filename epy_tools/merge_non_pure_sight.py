...
PARSER.add_argument('-source', '--source_dir', type=str, help='其它的sacred資料夾路徑, e.g., ~/Download/sacred/')
PARSER.add_argument('-dest', '--output_dir', type=str, help='主要的sacred資料夾路徑, e.g., POEM/sacred/')
